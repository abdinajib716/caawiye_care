...
enum SettingFilterHook: string
{
    ...
    // UI Hooks - Email tab
    case SETTINGS_EMAIL_TAB_BEFORE_SECTION_START = 'filter.settings.email_tab_before_section_start';
    case SETTINGS_EMAIL_TAB_AFTER_SECTION_END = 'filter.settings.email_tab_after_section_end';
