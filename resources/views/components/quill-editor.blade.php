...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Media modal handler disabled - Media Library removed for healthcare application
        const mediaModalHandler = function() {
            alert('{{ __("Media uploads will be available in future updates") }}');
        };
        ...
        // Media selection handler disabled - Media Library removed for healthcare application
...
{{-- Media modal removed - Media Library removed for healthcare application --}}
