...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { text-align: center; margin-bottom: 30px; border-bottom: 2px solid #2d572c; padding-bottom: 20px; }
        .header h1 { color: #2d572c; font-size: 24pt; margin-bottom: 5px; }
        ...
        th { background-color: #2d572c; color: white; padding: 10px; text-align: left; font-size: 10pt; }
        td { border: 1px solid #ddd; padding: 8px; font-size: 10pt; }
        tr:nth-child(even) { background-color: #f9f9f9; }
        .total-row { background-color: #d4a017 !important; color: white; font-weight: bold; }
        .total-row td { border-color: #d4a017; }
        h3 { color: #2d572c; margin: 25px 0 10px 0; font-size: 14pt; }
...
<body>
    ...
    <h3>{{ __('Revenue by Service Type') }}</h3>
    <table>
        <tr>
        ...
        <tr>
            ...
            <td class="text-right">{{ $report['gross_revenue'] > 0 ? number_format(($amount / $report['gross_revenue']) * 100, 1) : 0 }}%</td>
        </tr>
        @endforeach
    </table>
    @endif
