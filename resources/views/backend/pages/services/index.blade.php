                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="flex h-8 w-8 items-center justify-center rounded-md bg-yellow-500 text-white">
                            <iconify-icon icon="lucide:star" class="h-5 w-5"></iconify-icon>
                        </div>
                    </div>
                    <div class="ml-4">
                        <div class="text-sm font-medium text-gray-500">{{ __('Featured Services') }}</div>
                        <div class="text-2xl font-bold text-gray-900">{{ number_format($statistics['featured_services']) }}</div>
                    </div>
                </div>
            </x-card>
